...
import 'package:sabak29_news_app_05/components/home_card_news.dart';
...
import 'package:sabak29_news_app_05/theme/app_texts_styles.dart';
...
class _HomeViewState extends State<HomeView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AppColors.scaffoldrColors,
      appBar: AppBar(
